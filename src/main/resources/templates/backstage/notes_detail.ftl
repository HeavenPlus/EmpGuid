	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div role="form">
				...
				<div class="form-group">
					 <label>作者</label><input id="author" name="author" type="text" class="form-control" value="${notes.author}"/>
				</div>
				<div class="form-group">
				...
				<div type="submit" class="btn btn-default" onclick="openURL('招聘简章', '/EmpGuid/manager/notesList?page=${currentPage}')">返回</div><br><br>
			</div>
