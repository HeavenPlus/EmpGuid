				...
				<tbody>
					<#list announcementList as announcement>
						<tr style="cursor:pointer;">
							...
							<td onclick="openURL('修改信息', '/EmpGuid/manager/annoDetail?id=${announcement.id}&page=${currentPage}')"><a>修改</a></td>
							<td onclick="openURL('信息列表', '/EmpGuid/manager/deleteAnno?id=${announcement.id}&page=${currentPage}')"><a>删除</a></td>
						</tr>
					</#list>
				</tbody>
			</table>
