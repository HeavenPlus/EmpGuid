	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div role="form">
				...
				<div class="form-group">
					 <label>作者</label><input id="author" name="author" type="text" class="form-control" value="${announcement.author}"/>
				</div>
				<div class="form-group">
				...
				<div type="submit" class="btn btn-default" onclick="openURL('信息列表', '/EmpGuid/manager/annoList?page=${currentPage}')">返回</div><br><br>
			</div>
